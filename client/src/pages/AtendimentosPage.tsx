...
export default function AtendimentosPage() {
  ...
  const totalAtendimentos = atendimentos?.totalCount ?? 0;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{isLoading ? "..." : totalAtendimentos}</div>
            <p className="text-xs text-muted-foreground mt-1">Evoluções registradas no mês</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {isLoading ? "..." : totalTerapeutas > 0 ? Math.round(totalAtendimentos / totalTerapeutas) : 0}
            </div>
