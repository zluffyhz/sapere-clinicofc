              ...
              <div className="space-y-4">
                {todayAppointments
                  .map((apt) => {
                    ...
                    return (
                      <div key={apt.id} className={`flex items-start gap-4 p-3 rounded-lg border ${apt.status === 'cancelled' ? 'opacity-60 bg-gray-50' : apt.status === 'absent' ? 'opacity-75 bg-orange-50' : ''}`}>
